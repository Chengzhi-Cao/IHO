...
def get_config_file_name(pre_extract = False, single=False):
    ...
    parser.add_argument('--path_config', default='/data/chengzhicao/Medical_Report/MedVQA/locvqa-master/config/sts2017/config_gcn.yaml', type=str, help='path to a yaml options file') 
