...
# define paths
path_data = '/data/chengzhicao/Medical_Report/MedVQA/locvqa-master/data/' + DATASET_NAME[dataset] + '_' + version
path_qa = jp(path_data, 'processed')
path_images = jp(path_data, 'images')
path_logs = '/data/chengzhicao/Medical_Report/MedVQA/locvqa-master/logs/' + dataset + '/config_' + config
